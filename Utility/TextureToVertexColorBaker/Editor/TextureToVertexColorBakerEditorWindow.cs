...
namespace XiheRendering.Utility.TextureToVertexColorBaker.Editor {
    public class TextureToVertexColorBakerEditorWindow : EditorWindow {
        ...
        private void OnGUI() {
            ...
            if (m_SourceMesh != null) {
                ...
                GUILayout.Label(m_SourceMesh.vertexCount.ToString());
                GUILayout.EndHorizontal();

                GUILayout.BeginHorizontal();
                GUILayout.Label("Color Count");
                GUILayout.Label(m_SourceMesh.colors.Length.ToString());
                GUILayout.EndHorizontal();
            }
        ...
        private IEnumerator StartBake() {
            ...
            for (var i = 0; i < vertices.Length; i++) {
                ...
                if (m_SourceMesh.colors.Length > i) {
                    originAlpha = m_SourceMesh.colors[i].a;
                }
